...
```{r echo=FALSE, warning=FALSE, message=FALSE, fig.align='center', fig.height=6, results='hide'}
library("datasets")
library("spsann")
library("sp")
library("rgeos")
...
Schedule2 <- scheduleSPSANN(chains = 1, initial.temperature = 30,
                           ...
                           y.min = 0, cellsize = 40)
res<-optimPPL(points = 50, candi = candid, schedule = Schedule2, lags=10, lags.type = "equidistant", 
              progress=NULL, cutoff=3000)

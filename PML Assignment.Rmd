...
CM1<-confusionMatrix(train.set$classe, predismodelrf)
CM2<-confusionMatrix(train.set$classe, predismodelnb)
CM3<-confusionMatrix(train.set$classe, predismodelgbm)
CM4<-confusionMatrix(test.set$classe, predosmodelrf)
CM5<-confusionMatrix(test.set$classe, predosmodelnb)
CM6<-confusionMatrix(test.set$classe, predosmodelgbm)
...
cat("<h3> Confusion matrix for Random Forests model training subset </h3>")
CM1
cat("<h3> Confusion matrix for Random Forests model testing subset </h3>")
CM4
cat("<h3> Confusion matrix for Naive Bayes model training subset </h3>")
CM2
cat("<h3> Confusion matrix for Naive Bayes model testing subset </h3>")
CM5
cat("<h3> Confusion matrix for Sochastic Gradient Boosting model training subset </h3>")
CM3
cat("<h3> Confusion matrix for Sochastic Gradient Boosting model testing subset </h3>")
CM6
```
